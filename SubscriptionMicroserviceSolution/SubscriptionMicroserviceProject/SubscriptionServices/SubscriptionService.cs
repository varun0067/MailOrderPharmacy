...
namespace SubscriptionMicroserviceProject.SubscriptionServices
{
    public class SubscriptionService : ISubscriptionService
    {
        ...
        //{
        //    var findSubscription = subscriptionDBHelper.memberSubscriptions.Find(s => s.SubscriptionId == subscriptionId);
        //    if (findSubscription == null)
        //    {
        //        return (" No Such Subscription Found");//BadRequest
        //    }
        //    HttpClient client = new HttpClient();
        //    client.BaseAddress = new Uri("http://localhost:2393");
        //    HttpResponseMessage response = client.GetAsync("/api/Refill/getRefillStatus/" + subscriptionId).Result;

        //    if (response.StatusCode == HttpStatusCode.OK)
        //    {
        //        string resultContent = response.Content.ReadAsStringAsync().Result;
        //        if (resultContent == "Refill Completed")
        //        {
        //            subscriptionDBHelper.Remove(subscriptionId);
        //            return ("Successfully Unsubscribed");//Ok
        //        }
        //        else
        //            return (" Un-subscribe is not successful due to pending payment");//Ok
        //    }
        //    else
        //        return ("Subscription Data Not Found");//NotFound
        ...
        //{
        //    return subscriptionDBHelper.Get();
        //}
