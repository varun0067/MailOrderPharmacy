...
namespace DrugServiceAPIProject
{
    public class Startup
    {
        ...
        {
            services.AddSingleton<DrugDBHelper>();
            services.AddSingleton<IDrugRepo, DrugRepositary>();
            services.AddSingleton<IDrugService, DrugService>();
